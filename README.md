...
[Trello board](https://bit.ly/BracketsTrelloBoard) that we're anxious to add and other
...
on the wiki, [intro videos](https://youtube.com/user/CodeBrackets) on YouTube, and news on the [Brackets blog](https://blog.brackets.io/).

How to install and run Brackets
-------------------------------
#### Download

Installers for the latest stable build for Mac, Windows and Linux (Debian/Ubuntu) can be [downloaded here](https://brackets.io/).
...
Also, see the [release notes](https://github.com/adobe/brackets/wiki/Release-Notes)
...
[CodeMirror](https://github.com/codemirror/CodeMirror)&mdash;thanks to Marijn for
...
* Watch our [Waffle Kanban Board](https://waffle.io/adobe/brackets): Work items in [![Stories In Ready](https://badge.waffle.io/adobe/brackets.svg?label=ready&title=Ready)](https://waffle.io/adobe/brackets) are next. The entire development process is outlined in the [Developer Guide](https://github.com/adobe/brackets/wiki/Brackets-Developers-Guide).

#### Contact Info

* **Email:** [admin@brackets.io](mailto:admin@brackets.io)
...
* **Developers Mailing List:** https://groups.google.com/group/brackets-dev
* **Twitter:** [@brackets](https://twitter.com/brackets)
* **Blog:** https://blog.brackets.io/
* **IRC:** [#brackets on Freenode](https://webchat.freenode.net/?channels=brackets)
